...
| --- | --- | --- | --- |
| source/raw/example.md | A | endpoint-ref | embedded OpenAPI fragment |

## Readiness Checklist
| Element | Status | Evidence (Tier A/B path:line) | Notes |
| --- | --- | --- | --- |
| GET /example | sourced | source/raw/example.md:73 | |
| Request body (GET) | N/A | — | GET has no body |
| Response 200 schema | missing | source/raw/example.md:153 | official schema empty |
| Authentication | sourced | source/raw/auth.md:22 | |
